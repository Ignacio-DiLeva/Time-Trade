...
{
    public partial class Watchlist : MaterialForm
    {
        ...
        public Watchlist(Point getLocation)
        {
            InitializeComponent();
            getLocation.X += 225;
        ...
        private void OnLoad(object sender, EventArgs e)
        {
            ...
            Watchlist3.SelectedIndex = Globals.GetIndexOfCompany(Globals.watchlistData[12, 0]);
            try
            {
                UpdateLabels();
            }
        ...
        {
            company1.Text = Watchlist1.SelectedItem.ToString().Split(' ')[0] + " $" + Globals.ReadInfo(Watchlist1.SelectedItem.ToString().Split(' ')[0], Globals.d);
            company2.Text = Watchlist2.SelectedItem.ToString().Split(' ')[0] + " $" + Globals.ReadInfo(Watchlist2.SelectedItem.ToString().Split(' ')[0], Globals.d);
            company3.Text = Watchlist3.SelectedItem.ToString().Split(' ')[0] + " $" + Globals.ReadInfo(Watchlist3.SelectedItem.ToString().Split(' ')[0], Globals.d);
